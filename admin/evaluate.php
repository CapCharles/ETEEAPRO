...
function generateEnhancedRecommendation($score, $programCode, $status, $criteriaMissing = [], $passedSubjects = [], $curriculumSubjects = []) {
    ...
    switch($status) {
        case 'qualified':
            ...
            $recommendations[] = "";
            $recommendations[] = "Congratulations! Your professional experience and competencies demonstrate substantial";
            $recommendations[] = "equivalency to formal academic study. Based on our comprehensive evaluation, you have";
            $recommendations[] = "successfully qualified for the Expanded Tertiary Education Equivalency and Accreditation";
            $recommendations[] = "Program (ETEEAP).";
            $recommendations[] = "";
            $recommendations[] = "══════════════════════════════════════════════════════════";
            ...
            $recommendations[] = "• Required (Bridging): " . count($bridgingSubjectNames) . " subjects ({$bridgingUnits} units)";
        ...
        case 'partially_qualified':
            ...
            $recommendations[] = "You have achieved partial qualification status under the ETEEAP program.";
            $recommendations[] = "";
            $recommendations[] = "══════════════════════════════════════════════════════════";
            ...
            $recommendations[] = "";
            $recommendations[] = "• Total Curriculum Subjects: {$totalSubjects}";
            $recommendations[] = "• Credited: {$creditedCount} subjects";
            $recommendations[] = "• Required (Bridging): " . count($bridgingSubjectNames) . " subjects ({$bridgingUnits} units)";
            $recommendations[] = "• Estimated Completion: 2-3 semesters";
            break;
            
        case 'not_qualified':
            $recommendations[] = "**ASSESSMENT OUTCOME: FURTHER PREPARATION RECOMMENDED**";
            $recommendations[] = "";
            $recommendations[] = "Based on your assessment score of {$score}%, we recommend additional preparation before";
            $recommendations[] = "pursuing ETEEAP credit recognition.";
            $recommendations[] = "";
            $recommendations[] = "══════════════════════════════════════════════════════════";
    ...
    $recommendations[] = "Contact the Admissions Office";
    $recommendations[] = "";
