...
<?php endif; ?>
    ...
    <div class="modal fade" id="evaluationConfirmModal" tabindex="-1" aria-labelledby="evaluationConfirmModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="evaluationConfirmModalLabel">
                ...
                <div class="modal-body">
                    ...
                    <ul class="mb-3">
                        <li>Save the evaluation scores and status</li>
                        <li>Generate the final recommendation</li>
                        <li>Send an email notification to the candidate</li>
                        <li>Update the application status</li>
                    </ul>
                    
                    <div id="evaluationSummary" class="border rounded p-3 bg-light">
                        <h6 class="mb-2">Evaluation Summary:</h6>
                        <div class="row">
                            <div class="col-6">
                                <strong>Final Score:</strong>
                            </div>
                            <div class="col-6">
                                <span id="modalFinalScore" class="badge bg-primary">-</span>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <span id="modalFinalStatus" class="badge">-</span>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <span id="modalCandidateName"><?php echo htmlspecialchars($current_application['candidate_name'] ?? '-'); ?></span>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <span id="modalCandidateEmail"><?php echo htmlspecialchars($current_application['candidate_email'] ?? '-'); ?></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="confirmSubmitEvaluation">
    ...
    <div class="modal fade" id="emailProgressModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center py-4">
                    ...
                    <h5>Sending Evaluation...</h5>
                    <p class="text-muted mb-0">Please wait while we process your evaluation and send the notification.</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const evaluationForm = document.querySelector('form[method="POST"]');
    const submitButton = document.querySelector('button[name="submit_evaluation"]');
    const confirmModal = new bootstrap.Modal(document.getElementById('evaluationConfirmModal'));
    const progressModal = new bootstrap.Modal(document.getElementById('emailProgressModal'));
    
    if (submitButton && evaluationForm) {
        submitButton.addEventListener('click', function(e) {
            e.preventDefault();
            
            // Calculate current score for modal
            const scoreText = document.getElementById('currentLiveScore')?.textContent || '0';
            const finalScore = parseFloat(scoreText);
            ...
            // Update modal with evaluation summary
            document.getElementById('modalFinalScore').textContent = finalScore + '%';
            document.getElementById('modalFinalStatus').textContent = status;
            document.getElementById('modalFinalStatus').className = 'badge ' + statusClass;
        ...
        // Handle confirmation
        document.getElementById('confirmSubmitEvaluation').addEventListener('click', function() {
            confirmModal.hide();
            
            // Check if email should be sent
            const sendEmail = document.getElementById('confirmSendEmail').checked;
            
            // Add hidden input for email flag
            let emailInput = evaluationForm.querySelector('input[name="send_email"]');
            if (!emailInput) {
                emailInput = document.createElement('input');
                emailInput.type = 'hidden';
                emailInput.name = 'send_email';
                evaluationForm.appendChild(emailInput);
            }
            emailInput.value = sendEmail ? '1' : '0';
