...
// Get bridging subject names to exclude from passed list
$bridgingSubjectNames = array_column($bridging_requirements, 'subject_name');

// Filter passed subjects (subjects NOT in bridging requirements)
$creditedSubjects = [];
...
<div class="assessment-card p-4 mb-4">
    ...
    <p class="text-muted small mb-3">
        The following subjects have been credited based on demonstrated competencies and uploaded evidence:
    </p>
        ...
        <table class="table table-bordered table-hover">
            <thead class="table-success">
                <tr>
                    ...
                    <th style="width: 40%;">Evidence/Source</th>
                </tr>
            </thead>
            <tbody>
                <?php $passedCount = 0; ?>
                ...
                <?php 
                $passedCount++;
                $evidence = isset($passedSubjects[$subject['name']]) 
                    ? $passedSubjects[$subject['name']] 
                    : 'Credit via ETEEAP assessment';
                ?>
                <tr>
                    <td class="text-center"><?php echo $passedCount; ?></td>
                    <td>
            ...
            <tfoot class="table-light">
                <tr>
                    <td colspan="3" class="text-end">
                        <strong>Total Credited Subjects: <?php echo $passedCount; ?></strong>
                    </td>
                </tr>
            </tfoot>
        </table>
...
<!-- Required Bridging Subjects Table -->
...
<div class="assessment-card p-4 mb-4">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td class="text-center"><?php echo $requiredCount; ?></td>
                    <td>
                        <strong><?php echo htmlspecialchars($req['subject_name']); ?></strong>
                    </td>
                    <td class="text-center">
                        <code><?php echo htmlspecialchars($req['subject_code']); ?></code>
                    </td>
                    <td class="text-center">
                        <span class="badge bg-primary"><?php echo (int)$req['units']; ?> units</span>
                    </td>
                    <td class="text-center">
            ...
            <tfoot class="table-light">
                <tr>
                    <td colspan="3" class="text-end"><strong>Total Bridging Requirements:</strong></td>
                    <td class="text-center">
                        <strong class="text-primary"><?php echo $totalUnits; ?> units</strong>
                    </td>
                    <td class="text-center">
                        <strong><?php echo $requiredCount; ?> subjects</strong>
                    </td>
                </tr>
            </tfoot>
        </table>
    ...
    <div class="alert alert-info mt-3 mb-0">
        ...
        <strong>Program Completion Timeline:</strong>
        <ul class="mb-0 mt-2">
            <li>Credited Subjects: <?php echo count($creditedSubjects); ?> subjects</li>
            <li>Bridging Requirements: <?php echo $requiredCount; ?> subjects (<?php echo $totalUnits; ?> units)</li>
            <li>Estimated Completion: 1-2 semesters (depending on subject availability)</li>
        </ul>
    </div>
</div>
<?php endif; ?>
