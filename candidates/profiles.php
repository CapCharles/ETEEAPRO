...
if ($_POST && isset($_POST['resubmit_document'])) {
    ...
    // Verify original form belongs to user - REMOVED restrictive validation
    try {
        ...
        // REMOVED: restrictive status check
    } catch (PDOException $e) {
                ...
                <div class="card profile-card">
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="profileTabsContent">
                            ...
                            <!-- Application Forms Tab (only shown if not approved) -->
                            <?php if ($user['application_form_status'] !== 'approved'): ?>
                            <div class="tab-pane fade" id="forms" role="tabpanel">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="mb-0">Application Forms</h5>
                                    <?php if (empty($application_forms) || $user['application_form_status'] === 'rejected'): ?>
                                ...
                                <div class="document-item document-<?php echo str_replace('_', '-', $form['status']); ?> <?php echo $form['resubmission_of'] ? 'document-resubmission' : ''; ?>">
                                    <div class="row align-items-start">
                                        ...
                                        <div class="col-md-4 text-md-end">
                                            ...
                                            <button class="btn btn-outline-primary btn-sm mb-2" onclick="viewDocument('<?php echo htmlspecialchars($form['stored_filename']); ?>', '<?php echo htmlspecialchars($form['file_description']); ?>')">
                                                <i class="fas fa-eye me-1"></i>View Document
                                            </button>
                                            <br>
                                            
                                            <!-- Resubmit button logic -->
                                            <?php if ($form['status'] === 'needs_revision'): ?>
                                                <?php
                                                // Check if this specific form has already been resubmitted
                                                $this_form_resubmitted = false;
                                                foreach ($application_forms as $check_form) {
                                                    if ($check_form['resubmission_of'] == $form['id']) {
                                                        $this_form_resubmitted = true;
                                                        break;
                                                    }
                                                }
                                                ?>
                                                ...
                                                <?php if (!$this_form_resubmitted): ?>
                                                    ...
                                                    <button class="btn btn-warning btn-sm" onclick="showResubmitForm(<?php echo $form['id']; ?>, '<?php echo htmlspecialchars($form['file_description'], ENT_QUOTES); ?>')">
                                                        <i class="fas fa-edit me-1"></i>Resubmit Document
                                                    </button>
                                                <?php else: ?>
                                                    <!-- This specific document has been resubmitted -->
                            ...
                            <!-- Applications Tab (only shown if approved) -->
                            <?php if ($user['application_form_status'] === 'approved'): ?>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="assessment.php?id=<?php echo $app['id']; ?>" class="btn btn-sm btn-outline-primary">
