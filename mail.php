...
try {
    ...
    $mail->Username   = 'cspbank911@gmail.com';                     //SMTP username
    $mail->Password   = 'uzhtbqmdqigquyqq';                               //SMTP password
    $mail->SMTPSecure = 'ssl';
	//Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('redpixelroze@gmail.com', 'PRISM HOTEL');
    $mail->addAddress('redpixelroze@gmail.com', 'ETEEAPRO');     //Add a recipient
